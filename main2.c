...
int main() {
  ...
  waveform = sineWave(0.5, 0, mtof(64, 10), seconds, srate, nchan);
  waveform2 = sineWave(0.5, 0, mtof(63, 10), seconds, srate, nchan);
  ...
  */
  ...
  waveform = envelope(timeX, ampY, 11, waveform2, seconds, srate, nchan);
  ...
  nchan = 2;
  //frees both blocks inside toStereo
  waveform = toStereo(waveform, waveform2, seconds, nchan);
  ...
  //display_wave(waveform, seconds, srate);
